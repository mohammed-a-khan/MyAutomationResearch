...
public class RecordingConfig {
    ...
    public RecordingConfig() {
        ...
        this.browserOptions = new HashMap<>();
     ...
     *
     * @param browserOptions Map of browser options
     */
    public void setBrowserOptions(Map<String, Object> browserOptions) {
     ...
     */
    public RecordingConfig addBrowserOption(String key, Object value) {
        if (this.browserOptions == null) {
            this.browserOptions = new HashMap<>();
        }
        this.browserOptions.put(key, value);
        return this;
    }
